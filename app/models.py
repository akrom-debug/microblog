...
from app.search import add_to_index, remove_from_index, query_index #type: ignore
import json
from time import time
...
class User(UserMixin, db.Model):
    ...
    last_message_read_time: so.Mapped[Optional[datetime]] #chapter 21 
